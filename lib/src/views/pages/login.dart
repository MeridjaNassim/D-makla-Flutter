...
class LoginFromGuestWidget extends StatelessWidget {
  final Function(BuildContext context,dynamic result) onLogin;
  final Function(BuildContext context,dynamic result) onCancel;

  LoginFromGuestWidget({this.onLogin, this.onCancel});
...
class LoginFormModal extends StatefulWidget {
  final Function  onCancel;
  const LoginFormModal({Key key, this.onCancel}) : super(key: key);

  @override
  _LoginFormModalState createState() => _LoginFormModalState();
}

class _LoginFormModalState extends State<LoginFormModal> {
  String _phoneNumber;
  String _password;
