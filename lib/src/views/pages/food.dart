...
import 'package:dmakla/src/views/elements/ExtraItemWidget.dart';
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        return ListTile(
          ...
          trailing: Text(
            state.menu.pricings.getPriceOfVariant(variant).toInt().toString() +
                "DA",
                      ...
                      child: Padding(
                        ...
                        child: Wrap(
                          children: [
                            ...
                            Text(
                                menuState.menu.description ?? "no description"),
                            SizedBox(
                              height: 20,
                            ),
                        ...
                        Stack(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                state.currentOrderPrice.toInt().toString() +
                                    "DA",
                                style: Theme.of(context)
                                    .textTheme
                                    .display1
